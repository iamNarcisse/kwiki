    ...
    return (
        <div>
            ...
            <div className="row1">
                ...
                <span className="span1">Terms and Conditions</span>
                <b />
            ...
            <div className="row1">
                ...
                <div style={{fontSize: '24px', lineHeight: '28px'}}>Introduction</div>
                <br />

                <div style={{textAlign: 'justify', fontSize: '12px', lineHeight: '22px'}}>

                    Welcome to the kwikikarts.com.ng website (the "Site"). These terms & conditions ("Terms and Conditions") apply to the Site, and all of its divisions, subsidiaries, and affiliate operated Internet sites which reference these Terms and Conditions. <br />
                    This website is owned and operated by Kwiki Karts Nigeria. For the purposes of this website, "seller", "we", "us" and "our" all refer kwikikarts.com.ng
 <br />
...
<br />
       	...
       	<br /> <br />
                ...
                <div style={{fonSize: '24px', lineHeight: '28px'}}>
                    Terms and Conditions of Use
       </div><br />

                <div style={{color:'#ff0066', textAlign: 'left', fontSize: '18px', lineHeight: '22px', marginBottom: '5px'}}>Use of the Site</div>
...
Both parties agree that this website may only be used in accordance with these Terms and Conditions of Use. If you do not agree with the Terms and Conditions of Use or do not wish to be bound by them, you agree to refrain from using this website. <br />
                    We grant you a non-transferable, revocable and non-exclusive license to use this Site, in accordance with the Terms and Conditions of Use, for such things as: shopping for personal items sold on the site, gathering prior information regarding our products and services and making purchases. <br />
                    Commercial use or use on behalf of any third party is prohibited, except as explicitly permitted by us in advance. <br />
            ...
            <div style={{color : '#ff0066', textAlign: 'left', fontSize: '18px', lineHeight: '22px', marginBottom: '5px'}}>User Submissions</div>
 ...
 <br />
                By completing an order or signing up, you agree to receive a) emails associated with finalizing your order, which may contain relevant offers from third parties, and b) emails asking you to review Kwiki Karts and your purchase and c) promotional emails, SMS and push notifications from Kwiki Karts. You may unsubscribe from promotional emails via a link provided in each email. If you would like us to remove your personal information from our database, unsubscribe from emails and/or SMS, please email Customer Service
			<br />
                <br />
                <br />
            </div>

            <div style={{color : '#ff0066', textAlign: 'left', fontSize: '18px', lineHeight: '22px', marginBottom: '5px'}}>Information Available on Website</div>

            <div style={{textAlign: 'justify', fontSize: '12px', lineHeight: '22px'}}>
                You accept that the information contained in this website is provided as is, where is, is intended for information purposes only and that it is subject to change without notice. Although we take reasonable steps to ensure the accuracy of information and we believe the information to be reliable when posted, it should not be relied upon and it does not in any way constitute either a representation or a warranty or a guarantee. <br />
                Product representations expressed on this Site are those of the vendor and are not made by us. Submissions or opinions expressed on this Site are those of the individual posting such content and may not reflect our opinions. <br />
            ...
            <div style={{color : '#ff0066', textAlign: 'left', fontSize: '18px', lineHeight: '22px', marginBottom: '5px'}}>Accessibility of Website</div>

            <div style={{textAlign: 'justify', fontSize: '12px', lineHeight: '22px'}}>
                Our aim is to ensure accessibility to the website at all times, however we make no representation of that nature and reserves the right to terminate the website at any time and without notice. You accept that service interruption may occur in order to allow for website improvements, scheduled maintenance or may also be due to outside factors beyond our control.<br />
                <br />
                <br />
            </div>

            <div style={{color : '#ff0066', textAlign: 'left', fontSize: '18px', lineHeight: '22px', marginBottom: '5px'}}>Links and Thirds Party Websites</div>
...
<br />
            ...
            <div style={{color : '#ff0066', textAlign: 'left', fontSize: '18px', lineHeight: '22px', marginBottom: '5px'}}>Intellectual Property</div>
...
<br />
            ...
            <div style={{color : '#ff0066', textAlign: 'left', fontSize: '18px', lineHeight: '22px', marginBottom: '5px'}}>Data Protection</div>
...
<br /><br />
            ...
            <div style={{color : '#ff0066', textAlign: 'left', fontSize: '18px', lineHeight: '22px', marginBottom: '5px'}}>Indemnity</div>
...
<br /><br />
            ...
            <div style={{color : '#ff0066', textAlign: 'left', fontSize: '18px', lineHeight: '22px', marginBottom: '5px'}}>Applicable law and Juridiction</div>
...
<br /><br />
            ...
            <div style={{color : '#ff0066', textAlign: 'left', fontSize: '18px', lineHeight: '22px', marginBottom: '5px'}}>Arbitration</div>
...
<br />
            ...
            <div style={{color : '#ff0066', textAlign: 'left', fontSize: '18px', lineHeight: '22px', marginBottom: '5px'}}>Termination</div>
...
<br /><br />
            ...
            <div style={{color : '#ff0066', textAlign: 'left', fontSize: '18px', lineHeight: '22px', marginBottom: '5px'}}>Servibility</div>
...
<br />
            ...
            <div style={{color : '#ff0066', textAlign: 'left', fontSize: '18px', lineHeight: '22px', marginBottom: '5px'}}>Miscellaneous Provisions</div>

            <div style={{textAlign: 'justify', fontSize: '12px', lineHeight: '22px'}}>
                You agree that all agreements, notices, disclosures and other communications that we provide to you electronically satisfy any legal requirement that such communications be in writing.<br />
                Assigning or sub-contracting any of your rights or obligations under these Terms and Conditions of Use to any third party is prohibited unless agreed upon in writing by the seller. <br />
